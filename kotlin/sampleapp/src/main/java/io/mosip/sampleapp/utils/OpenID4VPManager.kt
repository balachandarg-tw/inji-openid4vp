...
object OpenID4VPManager {
    ...
    fun shareVerifiablePresentation(selectedItems: SnapshotStateList<Pair<String, VCWithFormat>>) {
    ...
    suspend fun sendVP(selectedItems: SnapshotStateList<Pair<String, VCWithFormat>>) = withContext(
        Dispatchers.IO) {
